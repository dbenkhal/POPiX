...
public class CstrMax4 extends ExpressionConstraint {

	ExpressionConstraint constr1, constr2, constr3, constr4;
	int activeConstr;

	public CstrMax4(ExpressionConstraint e1, ExpressionConstraint e2, ExpressionConstraint e3,
	...
	public String toString() {
		...
		return "max(" + constr1.toString() + "," + constr2.toString() + "," + constr3.toString() + ","
				+ constr4.toString() + ")";
	...
	public int evaluate(Map<String, Integer> env) {
		...
		return Integer.max(Integer.max(v1, v2), Integer.max(v3, v4));
	};
