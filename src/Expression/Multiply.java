...
public class Multiply extends AbstractClass {
	...
	AbstractClass left;
	AbstractClass right;
	ArrayList<Constraints> cmult = new ArrayList<Constraints>();
	ArrayList<Constraints> cmultAC = new ArrayList<Constraints>();
	...
	public Multiply(AbstractClass lt, AbstractClass rt) {
		left = lt;
		right = rt;
		lab = newLab();
		nbVarSupplement++;
	...
	public Multiply(AbstractClass lt, AbstractClass rt, int opPrec) {
		left = lt;
		right = rt;
	...
	public Numbers evaluate(Environment env) {
		res = left.evaluate(env).multiply(right.evaluate(env));
	...
	public void Generate_constraints(Map<String, String> varEnv) {
		...
		CstrConst ufpl2_sup = new CstrConst(right.xmax.ufp());
		CstrId accfl2 = new CstrId("accf_lab" + right.lab);
		z3ConstInt.add(accfl2.toString());
		Numbers mult = new FloatNumbers(left.xmax.multiply(right.xmax).getFloatValue());
		ExpressionConstraint r1_l = new CstrMinus(new CstrConst(mult.ufp()),
		...
		Numbers mult_inf = new FloatNumbers(left.xmin.multiply(right.xmin).getFloatValue());
		ExpressionConstraint r2_l = new CstrMinus(new CstrConst(mult_inf.ufp()),
		...
		z3ConstInt.add(r3);
		Numbers mult3 = new FloatNumbers(left.xmin.multiply(right.xmax).getFloatValue());
		ExpressionConstraint r3_l = new CstrMinus(new CstrConst(mult3.ufp()),
		...
		z3ConstInt.add(r4);
		Numbers mult4 = new FloatNumbers(left.xmax.multiply(right.xmin).getFloatValue());
		ExpressionConstraint r4_l = new CstrMinus(new CstrConst(Math.abs(mult4.ufp())),
		...
		Constraints iota_mul = new Constraints(IotaGt, new CstrPlus(cst_ulp1, cst_ulp2), "=");
		cmult.add(iota_mul);
		/* ulpe_Res */
		String ulpeRes = "ulpe_lab" + lab;
		AbstractClass.z3ConstInt.add(ulpeRes);
		ExpressionConstraint ulpErrAdd = new CstrPlus(new CstrId(ulpeLeft), new CstrId(ulpeRight));
		Constraints ulpErrAddCst = new Constraints(ulpeRes, ulpErrAdd, "<=");
		cmult.add(ulpErrAddCst);
		/*** accF ***/
		...
		cmult.add(ineq1);
		ConstraintsSet.allCst.addAll(cmult);
	}
	...
	public void Generate_constraints_Backward(Map<String, String> varEnv) {
		...
		CstrConst ufpls2 = new CstrConst(right.xmax.ufp());
		CstrConst ufplsup = new CstrConst(intervalleValue.getSup().ufp());
		...
		CstrConst ufplsinf = new CstrConst(right.xmin.ufp());
		CstrConst ufpsls2 = new CstrConst(intervalleValue.getInf().ufp());
		...
		CstrConst ufplssup = new CstrConst(right.xmax.ufp());
		...
		CstrConst ufplssupp = new CstrConst(right.xmin.ufp());
		...
		z3ConstInt.add(s1l2);
		CstrConst ufpls1l2 = new CstrConst(right.xmax.ufp());
		CstrConst ufpls2l1 = new CstrConst(left.xmax.ufp());
		CstrConst ufplsupl2 = new CstrConst(intervalleValue.getSup().ufp());
		CstrId accbll = new CstrId("accb_lab" + lab);
		z3ConstInt.add(accbll.toString());
		CstrId accfl1 = new CstrId("accf_lab" + left.lab);
		z3ConstInt.add(accfl1.toString());
		ExpressionConstraint sl2 = new CstrMinus(ufpls1l2,
				new CstrMax(new CstrMinus(new CstrPlus(new CstrMinus(ufplsupl2, ufpls2l1), new CstrConst(1)), accbll),
						new CstrMinus(new CstrMinus(ufplsupl2, ufpls2l1), accfl1)));
		Constraints S1l2 = new Constraints(s1l2, sl2, "=");
		cmult.add(S1l2);
		/** s2 **/
		String s2l2 = "s2l2_lab" + right.lab;
		z3ConstInt.add(s2l2);
		CstrConst ufpsls1l2 = new CstrConst(right.xmin.ufp());
		CstrConst ufplsinfl2 = new CstrConst(left.xmin.ufp());
		CstrConst ufpsls2l2 = new CstrConst(intervalleValue.getInf().ufp());
		CstrId accblll = new CstrId("accb_lab" + lab);
		z3ConstInt.add(accblll.toString());
		ExpressionConstraint sal2 = new CstrMinus(ufpsls1l2,
				new CstrMax(
						new CstrMinus(new CstrPlus(new CstrMinus(ufpsls2l2, ufplsinfl2), new CstrConst(1)), accblll),
						new CstrMinus(new CstrMinus(ufpsls2l2, ufplsinfl2), accfl1)));
		Constraints S2l2 = new Constraints(s2l2, sal2, "=");
		cmult.add(S2l2);
		/** s3 **/
		String s3l2 = "s3l2_lab" + right.lab;
		z3ConstInt.add(s3l2);
		CstrConst ufpl3 = new CstrConst(right.xmin.ufp());
		CstrConst ufplmin = new CstrConst(intervalleValue.getInf().ufp());
		...
		ExpressionConstraint s33 = new CstrMinus(ufpl3,
				new CstrMax(new CstrMinus(new CstrPlus(new CstrMinus(ufplmin, ufpl1sup), new CstrConst(1)), accbll3),
						new CstrMinus(new CstrMinus(ufplmin, ufpl1sup), accfl3)));
		Constraints Slb = new Constraints(s3l2, s33, "=");
		cmult.add(Slb);
		/** s4 **/
		String s4l2 = "s4l2_lab" + right.lab;
		z3ConstInt.add(s4l2);
		CstrConst ufpl4 = new CstrConst(right.xmax.ufp());
		CstrConst ufplmax = new CstrConst(intervalleValue.getSup().ufp());
		...
		ExpressionConstraint s44 = new CstrMinus(ufpl4,
				new CstrMax(new CstrMinus(new CstrPlus(new CstrMinus(ufplmax, ufpl1inf), new CstrConst(1)), accbl4),
						new CstrMinus(new CstrMinus(ufplmax, ufpl1inf), accfl4)));
	...
	public void Generate_Constraints_AC(Map<String, String> varEnv) {
		...
		cmultAC.add(add_ACR);
		ConstraintsSet.allCst.addAll(cmultAC);
